...
var DnDDomain = domain.Config{
	...
	Vocabulary: domain.Vocabulary{
		...
		TierNames: map[domain.TrustTier]string{
			domain.TierApprentice:  "Novice",
			domain.TierJourneyman:  "Adventurer",
			domain.TierExpert:      "Veteran",
			domain.TierMaster:      "Hero",
			domain.TierGrandmaster: "Legend",
		},
		RoleNames: map[domain.PartyRole]string{
			domain.RoleLead:     "Party Leader",
			domain.RoleExecutor: "Champion",
			domain.RoleReviewer: "Sage",
...
var DnDPromptCatalog = promptmanager.DomainCatalog{
	...
	TierGuardrails: map[domain.TrustTier]string{
		domain.TierApprentice: "You are a Novice adventurer. You are still learning:\n" +
		...
		domain.TierJourneyman: "You are a seasoned Adventurer. You have proven your worth:\n" +
	...
	ReviewConfig: &promptmanager.ReviewConfig{
		DefaultReviewLevel: domain.ReviewAuto,
		DefaultCriteria: []domain.ReviewCriterion{
			{Name: "narrative", Weight: 0.5, Threshold: 0.5, Description: "Story coherence and engagement"},
