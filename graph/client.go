// Package graph provides graph client utilities for interacting with the semstreams graph system.
package graph
...
func (gc *GraphClient) EmitEntityUpdate(ctx context.Context, entity semgraph.Graphable, eventType string) error {
...
type entityQueryResponse struct {
	Entity *semgraph.EntityState `json:"entity"`
	Error  string                `json:"error,omitempty"`
}

// GetEntity retrieves an entity by its full 6-part entity ID.
// Returns nil if the entity is not found.
func (gc *GraphClient) GetEntity(ctx context.Context, entityID string) (*semgraph.EntityState, error) {
...
type batchQueryResponse struct {
	Entities []semgraph.EntityState `json:"entities"`
	Error    string                 `json:"error,omitempty"`
}

// BatchGet retrieves multiple entities by their entity IDs.
// Returns only the entities that were found.
func (gc *GraphClient) BatchGet(ctx context.Context, ids []string) ([]semgraph.EntityState, error) {
	if len(ids) == 0 {
		return []semgraph.EntityState{}, nil
	}
...
func (gc *GraphClient) QueryByPrefix(ctx context.Context, prefix string, limit int) ([]semgraph.EntityState, error) {
	if limit <= 0 {
		limit = 100
	}
...
func (gc *GraphClient) QueryByPredicate(ctx context.Context, predicate string) ([]string, error) {
	bucket, err := gc.nats.GetKeyValueBucket(ctx, semgraph.BucketPredicateIndex)
	if err != nil {
...
func (gc *GraphClient) GetEntityDirect(ctx context.Context, entityID string) (*semgraph.EntityState, error) {
	bucket, err := gc.nats.GetKeyValueBucket(ctx, semgraph.BucketEntityStates)
	if err != nil {
...
func (gc *GraphClient) GetQuest(ctx context.Context, questID domain.QuestID) (*semgraph.EntityState, error) {
...
func (gc *GraphClient) GetAgent(ctx context.Context, agentID domain.AgentID) (*semgraph.EntityState, error) {
...
func (gc *GraphClient) GetParty(ctx context.Context, partyID domain.PartyID) (*semgraph.EntityState, error) {
...
func (gc *GraphClient) GetGuild(ctx context.Context, guildID domain.GuildID) (*semgraph.EntityState, error) {
...
func (gc *GraphClient) GetBattle(ctx context.Context, battleID domain.BattleID) (*semgraph.EntityState, error) {
...
func (gc *GraphClient) ListQuestsByPrefix(ctx context.Context, limit int) ([]semgraph.EntityState, error) {
	prefix := gc.config.TypePrefix(domain.EntityTypeQuest)
	return gc.QueryByPrefix(ctx, prefix, limit)
}

// ListAgentsByPrefix retrieves all agents on this board.
func (gc *GraphClient) ListAgentsByPrefix(ctx context.Context, limit int) ([]semgraph.EntityState, error) {
	prefix := gc.config.TypePrefix(domain.EntityTypeAgent)
	return gc.QueryByPrefix(ctx, prefix, limit)
}

// ListGuildsByPrefix retrieves all guilds on this board.
func (gc *GraphClient) ListGuildsByPrefix(ctx context.Context, limit int) ([]semgraph.EntityState, error) {
	prefix := gc.config.TypePrefix(domain.EntityTypeGuild)
	return gc.QueryByPrefix(ctx, prefix, limit)
}
