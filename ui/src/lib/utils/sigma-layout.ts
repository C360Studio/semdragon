 ...
 *
 * The controller runs FA2 in a web worker for 3 seconds (configurable) then
 * stops automatically. This keeps the graph from jittering indefinitely while
 * still giving nodes time to find stable positions.
 *
 ...
 * These values are tuned for a medium-density game entity graph (~200 nodes).
 */
