...
// Factory creates a new Executor component from configuration.
func Factory(rawConfig json.RawMessage, deps component.Dependencies) (component.Discoverable, error) {
	...
	if len(rawConfig) > 0 {
		if err := json.Unmarshal(rawConfig, &config); err != nil {
			return nil, errs.Wrap(err, "executor", "Factory", "unmarshal config")
		}
	}
...
// Register adds the Executor component to the registry.
