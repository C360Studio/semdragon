...
func TestParseFormat(t *testing.T) {
	// Default is FormatMarkdown — chosen so existing call sites that expect
	// "fetch and read full content" work without an explicit format argument.
	cases := map[string]Format{
		...
		"  RAW  ":   FormatRaw,
		"MarkDown":  FormatMarkdown,
		"junk_word": FormatMarkdown, // unknown → default
	}
